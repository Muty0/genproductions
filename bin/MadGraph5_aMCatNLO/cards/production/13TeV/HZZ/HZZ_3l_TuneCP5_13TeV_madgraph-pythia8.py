...
#    args = cms.vstring('/afs/cern.ch/user/t/tmu/public/WWZZ_3l_22/qq_wwzz_el8_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
...
generator = cms.EDFilter(
    "Pythia8ConcurrentHadronizerFilter",
        ...
        processParameters = cms.vstring(
            ...
            'ResonanceDecayFilter:daughters = 24,24,11,11,11',
          ),
