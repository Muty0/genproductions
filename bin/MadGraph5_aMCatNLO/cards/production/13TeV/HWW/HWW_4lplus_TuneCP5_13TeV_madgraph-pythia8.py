...
externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    args = cms.vstring('/afs/cern.ch/user/t/tmu/public/MC_samples/HWW_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
...
generator = cms.EDFilter(
    "Pythia8ConcurrentHadronizerFilter",
        ...
        processParameters = cms.vstring(
            ...
            'ResonanceDecayFilter:daughters = 23,23,11,11,11,11',
          ),
